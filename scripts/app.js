...
const movieQoute = document.querySelector('.movie-info-quote');
const movieOverview = document.querySelector('.movie-info-overview');
const footerYear = document.querySelector('.year');

window.onload = () => {
    let url = 'https://api.themoviedb.org/3/movie/550988?api_key=d842bf344a8b9c46a657b2ece686ea9c';
    ...
    .then(data =>{
        ...
        movieQoute.textContent = data.tagline;
